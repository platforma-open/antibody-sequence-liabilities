...
const structuralTypes = new Set(["Missing Cysteines", "Extra Cysteines"]);
...
function regionScopeSuffix(
  regions: string[] | undefined,
  allRegionNames: readonly string[],
): string {
...
function getLiabilitySetLabel(data: {
  ...
  const customSuffix =
    customCount === 1 ? " + 1 Custom" : customCount > 1 ? ` + ${customCount} Custom` : "";
