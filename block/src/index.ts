...
import { platforma } from "@platforma-open/milaboratories.antibody-sequence-liabilities.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type AntibodySequenceLiabilitiesBlockContract = BlockContract;
export type AntibodySequenceLiabilitiesBlockOutputs  = BlockOutputs;
export type AntibodySequenceLiabilitiesBlockData     = BlockData;
export const AntibodySequenceLiabilitiesBlockPointer = BlockPointer;
